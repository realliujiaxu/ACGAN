## Official implementation Attribute Consistent GAN (ACGAN)

## Install

### Setup environment
1. Setup environment following https://github.com/lucidrains/stylegan2-pytorch

2. Then install tensorboard for logging
```bash
...
2. Put or link to /path/to/ACGAN/data/CelebA, orgnized directory structure like:
```angular2html
CelebA
|--Anno
